...
<div class="max-w-5xl mx-auto bg-white rounded-xl shadow-xl p-6 space-y-6">
  ...
  <form method="post" class="grid gap-4 md:grid-cols-2">
    ...
    <div class="md:col-span-2">
      <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">✅ เพิ่มผู้ใช้</button>
    </div>
  </form>
  ...
  <p><a href="../dashboard/admin.php" class="text-blue-600 hover:underline">🔙 กลับแดชบอร์ด</a></p>
</div>
</body>
</html>
