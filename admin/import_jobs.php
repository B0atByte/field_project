...
<div class="md:hidden flex items-center justify-between px-6 py-4 bg-white shadow-sm border-b border-gray-200">
  ...
  <button onclick="toggleSidebar()" class="p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <form id="importForm" method="post" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="relative">
                  ...
                  <div onclick="document.getElementById('fileInput').click()"
                    ...
                    <div class="flex flex-col items-center space-y-3">
                      ...
                      <div>
                        <p class="text-base font-medium text-gray-700 group-hover:text-blue-600">คลิกเพื่อเลือกไฟล์</p>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-50 rounded-lg p-5 border border-gray-200">
                  ...
                  <select name="auto_delete_days" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
            ...
            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
              ...
              <div class="space-y-2 text-sm">
                ...
                <div class="flex justify-between">
                  ...
                  <span class="font-medium text-gray-800"><?= htmlspecialchars((string)$department_id ?: '-') ?></span>
                </div>
              </div>
            </div>
          </div>
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_FILES['excel'])) {
    ...
    for ($i = 1; $i < count($rows); $i++) {
        [
            $product, $contract_number, $customer_name, $customer_id_card, $location_area, $zone,
            $due_date, $overdue, $model, $model_detail, $color,
            $plate, $province, $os, $assignee_name
        ] = array_pad($rows[$i], 15, null);

        if ($is_delete_mode) {
            if (!empty(trim($contract_number))) {
        ...
        if (empty(trim($product)) || empty(trim($contract_number)) || empty(trim($customer_name))) {
